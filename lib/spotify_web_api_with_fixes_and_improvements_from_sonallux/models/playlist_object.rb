...
module SpotifyWebApiWithFixesAndImprovementsFromSonallux
  ...
  class PlaylistObject < BaseModel
    ...
    def to_s
      ...
      " external_urls: #{@external_urls}, followers: #{@followers}, href: #{@href}, id: #{@id},"\
      " images: #{@images}, name: #{@name}, owner: #{@owner}, public: #{@public}, snapshot_id:"\
      " #{@snapshot_id}, tracks: #{@tracks}, type: #{@type}, uri: #{@uri}>"
    end
    ...
    def inspect
      ...
      " #{@description.inspect}, external_urls: #{@external_urls.inspect}, followers:"\
      " #{@followers.inspect}, href: #{@href.inspect}, id: #{@id.inspect}, images:"\
      " #{@images.inspect}, name: #{@name.inspect}, owner: #{@owner.inspect}, public:"\
      " #{@public.inspect}, snapshot_id: #{@snapshot_id.inspect}, tracks: #{@tracks.inspect},"\
      " type: #{@type.inspect}, uri: #{@uri.inspect}>"
    end
  end
end
