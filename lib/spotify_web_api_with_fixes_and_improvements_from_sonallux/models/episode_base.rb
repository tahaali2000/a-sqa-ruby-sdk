...
module SpotifyWebApiWithFixesAndImprovementsFromSonallux
  ...
  class EpisodeBase < BaseModel
    ...
    def initialize(audio_preview_url = nil, description = nil,
                   ...
                   release_date_precision = nil, uri = nil, language = SKIP,
    ...
    def to_s
      ...
      " #{@resume_point}, type: #{@type}, uri: #{@uri}, restrictions: #{@restrictions}>"
    end
    ...
    def inspect
      ...
      " #{@type.inspect}, uri: #{@uri.inspect}, restrictions: #{@restrictions.inspect}>"
    end
  end
end
