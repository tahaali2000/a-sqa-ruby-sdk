...
module SpotifyWebApiWithFixesAndImprovementsFromSonallux
  ...
  class SimplifiedTrackObject < BaseModel
    ...
    def to_s
      ...
      "<#{class_name} artists: #{@artists}, available_markets: #{@available_markets},"\
      " disc_number: #{@disc_number}, duration_ms: #{@duration_ms}, explicit: #{@explicit},"\
      " external_urls: #{@external_urls}, href: #{@href}, id: #{@id}, is_playable:"\
      " #{@is_playable}, linked_from: #{@linked_from}, restrictions: #{@restrictions}, name:"\
      " #{@name}, preview_url: #{@preview_url}, track_number: #{@track_number}, type: #{@type},"\
    ...
    def inspect
      class_name = self.class.name.split('::').last
      "<#{class_name} artists: #{@artists.inspect}, available_markets:"\
      ...
      " #{@external_urls.inspect}, href: #{@href.inspect}, id: #{@id.inspect}, is_playable:"\
      " #{@is_playable.inspect}, linked_from: #{@linked_from.inspect}, restrictions:"\
      " #{@restrictions.inspect}, name: #{@name.inspect}, preview_url: #{@preview_url.inspect},"\
      " track_number: #{@track_number.inspect}, type: #{@type.inspect}, uri: #{@uri.inspect},"\
      " is_local: #{@is_local.inspect}>"
    end
  end
end
